...
Array.from(document.getElementsByClassName("jb-aside-toggle")).forEach(
  function (s) {
    s.addEventListener("click", function (e) {
      var t = s.getElementsByClassName("mdi")[0];
      document
        .getElementById(s.getAttribute("data-target"))
  ...
  Array.from(document.getElementsByClassName("jb-dropdown")).forEach(function (
    e
  ) {
    e.addEventListener("click", function (e) {
      var t = e.currentTarget
      ...
      e.currentTarget.parentNode.classList.toggle("is-active"),
        ...
        document.documentElement.classList.contains("has-aside-expanded") ||
          (document.documentElement.classList.add("has-aside-expanded"),
          document.getElementById("aside-main").classList.add("is-expanded"),
          Array.from(
            document.getElementsByClassName("jb-aside-toggle")
          ).forEach(function (e) {
            var t = e.getElementsByClassName("mdi")[0];
            t.classList.remove("mdi-forwardburger"),
              t.classList.add("mdi-backburger");
          }));
    });
  }),
  ...
  Array.from(
    document.getElementsByClassName("jb-has-perfect-scrollbar")
  ).forEach(function (e) {
    new PerfectScrollbar(e);
  });
var asideSecondaryToggle = function (e) {
  e.preventDefault();
  var t = document.getElementById("aside-main");
  Array.from(t.getElementsByClassName("is-active-original"))
    .concat(Array.from(t.getElementsByClassName("is-active")))
    .forEach(function (e) {
      e.classList.contains("jb-aside-secondary-toggle") ||
        (e.classList.contains("is-active-original")
          ? (e.classList.remove("is-active-original"),
            e.classList.add("is-active"))
          : (e.classList.remove("is-active"),
            e.classList.add("is-active-original")));
    }),
    e.currentTarget.classList.contains("jb-aside-secondary-toggle")
      ? e.currentTarget.classList.toggle("is-active")
      : Array.from(
          t.getElementsByClassName("jb-aside-secondary-toggle")
        ).forEach(function (e) {
          e.classList.remove("is-active");
        }),
    ...
    t.classList.toggle("has-secondary");
};
Array.from(
  document.getElementsByClassName("jb-aside-secondary-toggle")
).forEach(function (e) {
  e.addEventListener("click", asideSecondaryToggle);
}),
  Array.from(document.getElementsByClassName("aside-close")).forEach(function (
    e
  ) {
    e.addEventListener("click", asideSecondaryToggle);
  }),
  document
    ...
    .addEventListener("click", asideSecondaryToggle);
